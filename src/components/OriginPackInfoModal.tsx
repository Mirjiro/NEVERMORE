          ...
          >
            <div className="flex items-start justify-between gap-3 border-b border-zinc-800 px-5 pb-3 pt-5">
              <div>
                ...
                <p className="mt-1 text-xs text-zinc-500">{packType} Origin Box</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="overflow-y-auto px-5 py-3">
                ...
                return (
                  <div key={rarity} className={cn("py-2", i > 0 && "border-t border-zinc-900")}>
                    <div className="flex items-center justify-between text-sm">
                      <span className="font-semibold text-zinc-200">{rarity}</span>
              ...
              <h3 className="mb-2 mt-4 text-xs font-semibold uppercase tracking-wider text-zinc-500">Bonus</h3>
              {bonusOdds.map(([outcome, pct], i) => (
                ...
                >
                  <span className="text-zinc-300">{formatBonusLabel(outcome, packType)}</span>
                  <span className="font-mono text-zinc-100">{pct}%</span>
                </div>
              ))}
            </div>
