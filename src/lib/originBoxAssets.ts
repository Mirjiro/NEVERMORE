...
/**
 * Shared idle "alive" motion for the Classic box — a gentle hover bob plus a
 * slight left-right rock (not a full rotation). Used by both the carousel
 ...
 */
export const CLASSIC_BOX_IDLE_ANIMATE = {
  y: [0, -3, 0, 3, 0],
  rotate: [0, 2, 0, -2, 0],
};

export const CLASSIC_BOX_IDLE_TRANSITION: Transition = {
